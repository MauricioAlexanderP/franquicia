...
<body>
            ...
            <table class="table table-hover align-middle">
              ...
              <tbody>
                ...
                <tr>
                  <td>1</td>
                  <td>Electrónica</td>
                  <td>Productos como televisores, celulares, computadoras, etc.</td>
                  <td>
                    <button class="btn btn-edit me-1" onclick="editarTipoProducto(1)">
                      <i class="bi bi-pencil-square"></i> Editar
                    </button>
                    <button class="btn btn-delete" onclick="eliminarTipoProducto(1)">
      ...
      <div class="modal-content shadow-sm">
        ...
        <div class="modal-body">
          <form id="formTipoProducto">
            <input type="hidden" id="tipoProducto_id">
            <div class="mb-3">
              <label class="form-label">Catálogo</label>
              <input type="text" class="form-control" id="catalogo" required>
            </div>
            <div class="mb-4">
  ...
  <script>
    function editarTipoProducto(id) {
      // Simular edición
      alert("Editar tipo de producto con ID: " + id);
    ...
    function eliminarTipoProducto(id) {
      if (confirm("¿Estás seguro de eliminar este tipo de producto?")) {
        alert("Tipo de producto con ID " + id + " eliminado (simulado)");
      }
    }

    document.getElementById('formTipoProducto').addEventListener('submit', function(e) {
      e.preventDefault();
      alert("Tipo de producto guardado (simulado)");
      new bootstrap.Modal(document.getElementById('modalTipoProducto')).hide();
    });
  </script>
</body>
</html>
